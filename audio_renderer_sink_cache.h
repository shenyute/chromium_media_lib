...
#ifndef CHROMIUM_MEDIA_LIB_AUDIO_RENDERER_SINK_CACHE_H_
#define CHROMIUM_MEDIA_LIB_AUDIO_RENDERER_SINK_CACHE_H_
...
// Thread safe.
class MEDIA_EXPORT AudioRendererSinkCache {
 public:
...
#endif  // CHROMIUM_MEDIA_LIB_AUDIO_RENDERER_SINK_CACHE_H_
